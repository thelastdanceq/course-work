...
function makeFilterInputs() {
    ...
    for (let i = 0; i < table.rows[0].cells.length; i++) {
        ...
        if (input.id === 'score_onefilter' || input.id === "score_twofilter") {
            input.placeholder = table.rows[0].cells[i].innerHTML + ' від ...'
        } else {
            input.placeholder = table.rows[0].cells[i].innerHTML;
        }

        if (input.id === 'score_onefilter' || input.id === 'score_twofilter' || input.id === 'id_qualfilter' || input.id === 'id_ampluafilter' || input.id === 'id_teamfilter') {
            input.type = "number";
        } else {
            input.type = 'text'
        }
        ...
        if (input.id === "score_onefilter" || input.id === "score_twofilter") {
            ...
            secondInput.placeholder = input.placeholder.split(' ').slice(0, 2).join(' ') + " до ...";
